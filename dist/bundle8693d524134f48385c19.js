...
const createShowComment = async (id, username, comment) => {
  try {
    ...
    const response = await fetch(`${_utils_js__WEBPACK_IMPORTED_MODULE_0__["default"].baseUrl}apps/st5awnig42N9i1c9g8rb/comments`, requestOptions);
    if (response.ok) {
      return await response.json();
    }
    throw new Error(`HTTP error: ${response.status}`);
...
/******/ })()
;
//# sourceMappingURL=bundle8693d524134f48385c19.js.map